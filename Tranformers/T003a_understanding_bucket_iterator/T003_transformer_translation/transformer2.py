...
class Transformer2(nn.Module):
    ...
    def generate_square_subsequent_mask(self, trg_len, N=32):
        # N, trg_len = trg.shape
...
#         device
#     )
#     trg = torch.tensor([[1, 7, 4, 3, 5, 9, 2, 0, 4, 7], [1, 5, 6, 2, 4, 7, 6, 2, 0, 9]]).to(device)
#
#     src_pad_idx = 0
#     trg_pad_idx = 0
#     src_vocab_size = 10
