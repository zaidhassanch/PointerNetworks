Tasks for combining transformer encoder and GRU decoder:
    - create a copy of seq2seq
    - replace gru by transfomer decoder
    - pass through linear layer or use "cls" tag on last output
