...
class Transformer(nn.Module):
    ...
    def forward(self, src, trg, syntax_embedding):
        ...
        out1 = self.transformer(embed_src, embed_trg, syntax_embedding,
                                src_key_padding_mask=src_padding_mask, tgt_mask=trg_mask)
        # out1 = self.transformer(embed_src, embed_trg)


        # 12 x 512,    256
        # out1 = 12 x 32 x 512, 1 x 32 x 256
        if self.arch_flag == "END":
