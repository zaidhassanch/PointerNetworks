...
def getData(path, trainFile, valFile, testFile):
...
#    print("pad = ", sp_gec.decode(src_pad_idx))
    ...
    train_data, valid_data, test_data = TabularDataset.splits(path = path, train = trainFile, 
                                            validation=valFile, test = testFile, format='tsv', skip_header=False, fields = tv_datafields)
