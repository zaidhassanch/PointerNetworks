...
def getData(ger_tok, eng_tok):

  ger_voc = build_vocab(train_filepaths[0], ger_tok)
  eng_voc = build_vocab(train_filepaths[1], eng_tok)
...
german_vocab, english_vocab, train_data, val_data, test_data = getData(g_tok, e_tok)
